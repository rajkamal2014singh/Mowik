...
public class PhrasesActivity extends AppCompatActivity {
    ...
    //creating a variable for the mediaPlayer
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<Word> phrases = new ArrayList<Word>();
         ...
         Word w = new Word("Come here","әnni'nem",R.raw.phrase_come_here);
        phrases.add(w);
        ...
        WordAdapterPhrases phrasesAdapter = new WordAdapterPhrases(this,phrases,R.color.category_phrases);
